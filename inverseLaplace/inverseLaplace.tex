...
\begin{explanation}
From the table of Laplace transforms in Module \ref{Module 14-8} %Section~8.8,,
$$
...
cases you should refer to the table of Laplace transforms in Module \ref{Module 14-8}. %Section~8.8,,
\end{remark}
