...
\begin{remark}This section sets the stage for Sections~1.5,
1.6,
...
be different from that of Modules \ref{Module 12-2} and \ref{Module 12-3}%Sections~7.2 and 7.3,
where we
...
Module \ref{Module 7-CGH}%Section~5.2 
