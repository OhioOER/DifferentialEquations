...
\begin{problem} 
The  solution of the initial value problem is is: $\answer{((t - 1)e^{t} + 3e)e^{-t}}$.
\end{problem}

If we need specific values of the solution, we can access them as shown in the following cell:
