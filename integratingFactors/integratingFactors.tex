...
In the section on exact equations ({\color{red} reference 2.5}), we saw that if $M$, $N$, $M_y$ and $N_x$ are
...
Solving \eqref{eq:2.6.3} by the Procedure \ref{proc:solvingExactEq} of ({\color{red} reference 2.5}),
...
\eqref{eq:2.6.4} by Procedure \ref{proc:solvingExactEq} of ({\color{red} reference 2.5}). It would be
nice
