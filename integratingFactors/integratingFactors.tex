...
In \http{https://ximera.osu.edu/ode/main/exactEquations/exactEquations}{Trench 2.5}, Exact Equations, we saw that if $M$, $N$, $M_y$ and $N_x$ are
...
Solving \eqref{eq:2.6.3} by Procedure \ref{proc:solvingExactEq} of \http{https://ximera.osu.edu/ode/main/exactEquations/exactEquations}{Trench 2.5},
...
\eqref{eq:2.6.4} by Procedure \ref{proc:solvingExactEq} \http{https://ximera.osu.edu/ode/main/exactEquations/exactEquations}{Trench 2.5}. It would be
nice
...
$$
However, to solve \eqref{eq:2.6.27} by the method of \http{https://ximera.osu.edu/ode/main/exactEquations/exactEquations}{Trench 2.5}
